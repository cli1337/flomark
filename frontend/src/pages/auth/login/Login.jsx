              ...
              {demoInfo && (
                <div className="mt-4 p-4 bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-lg">
                  ...
                  <div className="space-y-1 text-xs text-gray-300">
                    <p><span className="text-gray-400">Email:</span> <code className="bg-black/30 px-2 py-0.5 rounded">{demoInfo.email}</code></p>
                    <p><span className="text-gray-400">Password:</span> <code className="bg-black/30 px-2 py-0.5 rounded">{demoInfo.password}</code></p>
                  </div>
                  <p className="text-xs text-gray-400 mt-2">
                    Use these credentials to try the app (read-only mode)
                  </p>
                </div>
              )}
